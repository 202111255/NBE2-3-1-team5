...
public class CartController {
    ...
    public Result updateCartList(@AuthenticationPrincipal Long userId, @PathVariable Long productId, @RequestParam int quantity) {
        return cartService.updateCartList(userId, productId, quantity);
    }
    ...
    public Result deleteCartList(@AuthenticationPrincipal Long userId, @PathVariable Long productId) {
